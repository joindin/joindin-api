...
class TalksControllerTest extends TalkBase
{
    ...
    public function testApproveAssignmentAsUserWhoClaimedThrowsException()
    {
        ...
        $pending_talk_claim_mapper
            ->expects($this->once())
            ->method('claimExists')
            ->will($this->returnValue(\Joindin\Api\Model\PendingTalkClaimMapper::SPEAKER_CLAIM));
    ...
    public function testApproveClaimAsHostWhoAssignedThrowsException()
    {
        ...
        $pending_talk_claim_mapper
            ->expects($this->once())
            ->method('claimExists')
            ->will($this->returnValue(\Joindin\Api\Model\PendingTalkClaimMapper::HOST_ASSIGN));
