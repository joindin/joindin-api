...
For details, see [`.github/workflows/continuous-integration.yml`](.github/workflows/continuous-integration.yml).
...
We are collecting code coverage from running tests with  [`phpunit/phpunit`](https://github.com/sebastianbergmann/phpunit).

Enable [Xdebug](https://xdebug.org) and run
